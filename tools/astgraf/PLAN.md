...
| 1b | **Pluto excluded, against the author's words** | He says *“all nine planets are a must for accuracy”*; NU ruled 2026-08-05 to **remove Pluto for now**. Grounds: absent from Predict.pdf's table and `BAND_BODIES`, previously leaked into scored tests as an audited defect, and named in no taught reading. Pluto stays COMPUTED by the canon — excluded only from `MAJOR_BODIES`. **Resolving this needs the author**: does "nine planets" include Pluto, and if so why is it absent from his own 28×11 table? Re-including it = one line + a re-run of every graded channel |
...
| # | Input | Unlocks |
|---|---|---|
| 1 | **THE GRAVITY QUESTION — he answered the location problem himself** | 2026-08-05: *“earths surface locations pass in the same time and location zone **14 times**… only a select few [produce events]… learn why through **gravity change calculations and not angular position changes which are too wide to be accurate**.”* He states angular geometry cannot locate — exactly what 15 null channels measured. **Ask: what gravity quantity discriminates the one passage in fourteen?** Until that is specified no angular test can settle location |
| 1b | **The “straight line” question, put to the author** | Of the July 2013 cluster he wrote *“Saturn / Jup in straight line and Saturn / Moon is straight line”*. Measured on his own EXPLODE chart every reading is 48–58° from 0°/180° — all four sit near a **trine**. Ask: does “straight line” mean a line on the plotted CURVE (the cos-fold mirror) rather than an ecliptic alignment? His *“discarding velocity of light”* already settles the frame (substratum / real positions) |
